        ...
        <main className="offset-md-2 my-3 px-3 pt-3" id="portfolio">
          ...
          <div className="container py-4">
            ...
            <div className="card-deck">
              <div class="card">
                ...
                ></img>
                <div class="card-body">
                  <h2 class="card-title">Airfighter</h2>
                  <p class="card-text">
                    This is a simple Canvas-based game that requires a solid
                    understanding of the principles of JavaScript programming to
                    customize.
                  </p>
                </div>
              ...
              <div class="card">
                ...
                ></img>
                <div class="card-body">
                  <h2 class="card-title">IMDB Clone</h2>
                  <p class="card-text">
          ...
          <div className="container py-4">
            ...
            <p className="my-0">
              ...
              to report sexual and/or domestic crimes to police for a variety of
              reasons. Public advocates will also be able to help the victims
